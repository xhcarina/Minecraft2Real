...
st.set_page_config(page_title="Minecraft2Real", page_icon="🌿", layout="wide")

st.title("🌿 Minecraft ↔ Real Landscape Translator")
st.caption("CycleGAN — upload a checkpoint and an image to translate between domains.")
